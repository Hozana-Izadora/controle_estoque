...
<?php
$this->assign('title', __('Categoria') );
...
<div class="view card card-primary card-outline">
  <div class="card-header d-sm-flex">
    <h2 class="card-title"><?= h($categoria->id_categoria) ?></h2>
  </div>
  ...
  <div class="card-footer d-flex">
    ...
    <div class="ml-auto">
      <?= $this->Html->link(__('Edit'), ['action' => 'edit',  $categoria->id_categoria], ['class' => 'btn btn-secondary']) ?>
