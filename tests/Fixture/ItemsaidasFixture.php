 ...
 * ItemsaidasFixture
 */
class ItemsaidasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    // phpcs:disable
    public $fields = [
        'id_itemsaida' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        'saida_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_itemsaida'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
